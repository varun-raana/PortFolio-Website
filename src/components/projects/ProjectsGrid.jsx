			...
			{projects &&
				...
				projects.map((item, index) => {
					return (
						<div
							key={index}
							className="group w-full h-fit motion-safe:group-hover:h-full flex flex-col p-4 pb-0 rounded-3xl overflow-hidden cursor-text border motion-safe:hover:drop-shadow-md bg-white">
							...
							<div className="mt-auto">
								<a
									...
									target={"_blank"}
									rel="noreferrer"
									className="inline-block text-clip bg-clip-text text-transparent font-semibold overflow-hidden bg-gradient-to-br from-orange-600 to-blue-500 text-lg md:text-xl my-4 capitalize">
									{item.name}
								</a>

								<div className="hidden motion-safe:group-hover:block transition-all duration-300 ease-in">
									<div className="mt-4">
